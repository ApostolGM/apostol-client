  ...
  return (
    <div className="bg-wasteland-800 p-4 rounded-lg border border-wasteland-600 mb-3 space-y-2">
      ...
      <div className="flex gap-2">
        ...
        <select value={form.icon_id || ''} onChange={e => update('icon_id', e.target.value)} className="w-16 bg-wasteland-900 border border-wasteland-600 rounded p-1.5 text-wasteland-100 text-sm">
          <option value="">—</option>
          {icons.map(icon => (
